...
import { SendForm, SendShapeSettingForm } from "../types/send-form";
    ...
    return new Promise<Shape | undefined>((resolve, reject) => {
        system.run(async () => {
            ...
            switch (shape.constructor) {
                case Cube: currentShape = 0; break;
                case Cuboid: currentShape = 1; break;
                case Plane: currentShape = 2; break;
                case Sphere: currentShape = 3; break;
                case Circle: currentShape = 4; break;
                case Cylinder: currentShape = 5; break;
            }
            ...
            for (const shapeName of shapeNames) {
                actionForm.button(`§l§6《§r ${shapeName}§l§6 》`);
            }
