import { Block, BlockType, BlockTypes, DimensionLocation, LocationOutOfWorldBoundariesError, Player, UnloadedChunksError } from "@minecraft/server";
...
export class Paint {
    ...
    public *paintShape(executor: Player, shape: Shape, origin: DimensionLocation) {
        ...
        const blockChangeMap = new Map<Block, BlockType | string>();
