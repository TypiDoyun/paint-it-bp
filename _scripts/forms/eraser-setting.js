...
export const playerErasers = new Map();
export const playerEraserOptions = new Map();
export const getEraserOption = (player) => {
...
export const sendEraserSettingForm = (player, backFunction) => {
    return new Promise((resolve, reject) => {
        system.run(async () => {
            ...
            if (response.canceled && response.cancelationReason === FormCancelationReason.UserBusy)
                return resolve(sendEraserSettingForm(player));
            ...
            if (response.selection === 0) {
                ...
                return resolve(sendDetailSettingForm(player, sendEraserSettingForm));
        });
    });
};
